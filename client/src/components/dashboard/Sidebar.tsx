...
export function Sidebar({ activeTab, setActiveTab, onNavigate, isOpen = true, onClose }: SidebarProps) {
        ...
        <>
            ...
            <aside
                className={`
                    ...
                    w-72 bg-white flex flex-col border-r border-gray-200 shadow-sm h-screen
            ...
            >
                ...
                <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
                    ...
                    <button
                        onClick={() => handleTabClick('climate')}
